...
export default class InputCreatedby extends Component {
  constructor(props) {
    super(props)
    {
      this.state = {
...
//   }
  ...
  >
    ...
    <Option value="data support team">Data Support Team</Option>
    <Option value="Line cleaning team">Line Cleaning Team</Option>
